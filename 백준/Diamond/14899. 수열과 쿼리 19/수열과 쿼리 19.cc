...
vector<Node> seg(400'001);
vector<ll> arr(100'001), lsum(400'001), lazydiv(400'001);
int N;
...
ll mn(int l, int r, int n = 1, int s = 1, int e = N) {
	prop(n, s, e);

	if (r < s || e < l) return INF;
	if (l <= s && e <= r) return seg[n].mn;
